...
function metaENT:ANPlusAlive()
	if IsValid(self) && ( ( self:IsNPC() && ( ( (SERVER) && !self:ANPlusInDeathAnim() && self:GetNPCState() != 7 ) || ( (CLIENT) && self:Health() > 0 ) ) ) || ( !self:IsNPC() && self:Health() > 0 ) || ( self:IsPlayer() && self:Alive() ) ) then
		return true		
	else	
		return false		
	end
